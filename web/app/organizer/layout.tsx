    ...
    return (
      <>
        ...
        >
          ...
          >
            <h1 className="text-heading-xl mb-md">Organizer Portal</h1>
            <p className="text-body-md text-muted mb-lg">
              Please sign in with your organizer wallet to access this dashboard.
            </p>
      ...
      <>
        ...
        >
          ...
          >
            ...
            <p className="text-body-md text-muted mb-lg">
              This account does not have organizer permissions. If you are an event organizer, please contact the platform administrator to request access.
            </p>
